...
x10 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(x9)
x11 = Conv2D(16, (3,3),strides=(1,1), activation='relu', padding='same')(x10)
x12 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(x11)
x13 = Dropout(rate=0.5)(x12)
x14 = Flatten()(x13)
x21 = Dense(32, activation='relu')(x14)
x1 = Dense(10, activation='softmax')(x21)
